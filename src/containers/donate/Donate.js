    ...
    return (
        ...
        <div className="in-body donate-container">
            ...
            <div className="donate-text">
                ...
                <Button className="donate-contact-us" label="Contact Us"/>
            </div>
            </div>
        ...
        <div className = "donate-info">
                ...
                <div className = "donate-infobox">
                    <div className = "d-info">
                        ...
                        <P text = "Our child focus programmes have thrust areas like Education, Health, Youth and Sports. 
                            Your donation will help provide critical support to children living in dire poverty through programmes, 
                            such as:"/>
                        <P text = "​Education: Scholarships for vocational training and college for qualified youth, 
                            as well as supplies, books and tuition to help support secondary school students."/>
                    </div>
                    <div className = "d-info">
                        <P className = "infobox-headings" text = "Make the planet green"/>
                        <P text = "Your donation will help us plant more and more trees. For every donation you make, our CSR partners will 
                            contribute exactly the same amount towards the Planet Green project."/>
                        <P className = "para23" text = "We would also love to have you as a volunteer for our tree plantation drive where you can experience the satisfaction of engaging with the project, on ground. 
                            For plantation drive schedules please drop us an email at info@heedindia.org"/>
                    ...
                    <div className = "d-info">
                        ...
                        <P text = "One of the most effective ways to help children is to improve the communities in which they live. 
                            You contributions will help us with:"/> 
                        <P className = "para32" text = "Community Centre Campaign: Our community centres, medical and dental clinics, playgrounds 
                            and sports fields are built right in the communities we serve."/>
                        <P className = "para33" text = "Building clean-water sources in impoverished communities is one of the surest ways to change 
                            lives dramatically"/>
                    </div>
                </div>
            </div>
