    ...
    return (
        <div className = "sports-main">
            ...
            <div className = "card-sport-info-1">
                ...
                header = "Athletics"
                para1 = "In the year 2019-2020, HEED India touched the lives of 88 students, with 2 coaches training them across 2 centers. "
